# System Head Component Classification — Hito 5.4

## Flow dependence of each TDH component
...
### Notes
- U40 (minimum required inlet pressure) is FLOW_INDEPENDENT — do not vary with Q².
- U39 (instrument drop) is UNKNOWN — do not default to Q² without curve or criterion.
- Equipment internal drop should use MANUFACTURER_CURVE when available.
