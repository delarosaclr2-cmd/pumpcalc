...
| **HIGH** | 2 | Significant engineering errors |
...
| Test | Status |
|------|--------|
| Unit tests (conversions, friction, NPSH, power) | 68 passed |
| Integration tests (legacy vs Excel) | 8 passed |
| Regression tests (current case) | 11 passed |
